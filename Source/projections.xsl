...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="document_projection" select="document('projections.xml')"/>
    ...
    <xsl:template match="/">
        ...
        <xsl:result-document method="html" href="projections_date.html">
            <html>
        ...
        <xsl:result-document method="html" href="projections_classement.html">
            <html>
    ...
    <xsl:template name="pied_de_page"></xsl:template>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="index.html">Tri par nom</a>
                        </li>
                        <li>
                            <a href="projections_classement.html">Tri par classement</a>
                        </li>
                        <li>
                            <a href="projections_date.html">Tri par heure</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <h5>
                    ...
                    <xsl:value-of select="../date"/>, salle num.

                    <xsl:value-of select="../salleNum"/>
